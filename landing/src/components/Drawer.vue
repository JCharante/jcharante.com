<template>
    <div>
        <q-list no-border link inset-delimiter>
            <q-list-header>Curated List of Links</q-list-header>
            ...
            <q-side-link item to="/aar" exact>
                <q-item>
                    <q-item-side icon="chat_bubble" />
                    <q-item-main label="After Action Reports"/>
                </q-item>
            </q-side-link>
            <q-side-link item to="/languages" exact>
                <q-item>
                    <q-item-side icon="language" />
                    <q-item-main label="Languages" sublabel="They're fun to speak"/>
                </q-item>
            </q-side-link>
