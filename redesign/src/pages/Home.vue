      ...
      <q-page>
        <SimplePage>
          <div>
            ...
            <p>I miss Aaron, and in memory of him I'll put the text to his most popular manifesto here until I come up with something better to put here.</p>
          </div>
          <hr>
          <div>
            <blockquote>
              <p>Guerilla Open Access Manifesto</p>
              ...
              <small><a href="http://aaronsw.com">Aaron Swartz</a> | July 2008, Eremo, Italy</small>
            </blockquote>
          </div>
        </SimplePage>
      </q-page>
